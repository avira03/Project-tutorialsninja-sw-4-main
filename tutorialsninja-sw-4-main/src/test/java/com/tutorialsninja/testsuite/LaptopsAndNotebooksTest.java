...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        checkOutPage.enterFirstName("Kinjal");
        checkOutPage.enterLastName("Patel");
        checkOutPage.enterEmail("kinjal36@gmail.com");
        checkOutPage.enterPhoneNumber("07917689782");
        checkOutPage.enterAddress1("16,Parkside Close");
        checkOutPage.enterCity("Dunstable");
        checkOutPage.enterPostCode("LU5 5TZ");
